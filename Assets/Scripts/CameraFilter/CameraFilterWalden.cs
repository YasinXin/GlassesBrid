...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Walden")]
public class CameraFilterWalden : MonoBehaviour
{
    #region Variables
    ...
    void Start()
    {
        SCShader = Shader.Find("lidx/lidx_filter_3");
        SCTexture1 = Resources.Load("images/f3_pict0", typeof(Texture))as Texture;
        SCTexture2 = Resources.Load("images/f3_pict1", typeof(Texture)) as Texture;
