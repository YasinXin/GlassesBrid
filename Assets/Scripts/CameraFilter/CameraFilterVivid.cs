...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Vivid")]
public class CameraFilterVivid : MonoBehaviour
{
    #region Variables
    ...
    [Range(0f, 20f)]
    public float blueColorLevel = 13.1f;
    [Range(0f, 3f)]
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_Vivid_1025", typeof(Texture))as Texture;
		blueColorLevel = 13.1f;
		level = 0.91f;
