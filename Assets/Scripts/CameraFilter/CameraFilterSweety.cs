...
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Sweety")]
public class CameraFilterSweety : MonoBehaviour
{
    #region Variables
    ...
    [Range(0f, 20f)]
    public float blueColorLevel = 14.0f;
    [Range(0f, 3f)]
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_sweety_0922", typeof(Texture))as Texture;
		blueColorLevel = 14.0f;
		level = 0.6f;
