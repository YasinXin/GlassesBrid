...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Nature")]
public class CameraFilterNature : MonoBehaviour
{
    #region Variables
    ...
    [Range(0f, 20f)]
    public float blueColorLevel = 9.7f;
    [Range(0f, 3f)]
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_Nature_1025", typeof(Texture))as Texture;
		blueColorLevel = 9.7f;
		level = 0.3f;
