...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Vintage")]
public class CameraFilterVintage : MonoBehaviour
{
    #region Variables
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_vintage_do_0930", typeof(Texture))as Texture;
