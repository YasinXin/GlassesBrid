...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Grass")]
public class CameraFilterGrass : MonoBehaviour
{
    #region Variables
    ...
    [Range(0f, 20f)]
    public float blueColorLevel = 9.1f;
    [Range(0f, 3f)]
    public float level = 0.43f;
    #endregion
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_grass_0901", typeof(Texture))as Texture;
		blueColorLevel = 9.1f;
		level = 0.43f;
