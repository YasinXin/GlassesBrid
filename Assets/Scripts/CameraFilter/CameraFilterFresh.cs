...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Fresh")]
public class CameraFilterFresh : MonoBehaviour
{
    #region Variables
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_Fresh_1025", typeof(Texture))as Texture;
