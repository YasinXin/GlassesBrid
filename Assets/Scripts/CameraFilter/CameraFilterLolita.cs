...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Lolita")]
public class CameraFilterLolita : MonoBehaviour
{
    #region Variables
    ...
    [Range(0f, 20f)]
    public float blueColorLevel = 11.8f;
    [Range(0f, 3f)]
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_lolita_0922", typeof(Texture))as Texture;
		blueColorLevel = 11.8f;
		level = 0.86f;
