...
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Beach")]
public class CameraFilterBeach : MonoBehaviour
{
    #region Variables
    ...
    void Start()
    {
		...
		SCTexture = Resources.Load("images/filter_beach_0701", typeof(Texture)) as Texture;
