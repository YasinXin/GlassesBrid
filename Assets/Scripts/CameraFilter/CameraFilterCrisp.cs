...
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter/Crisp")]
public class CameraFilterCrisp : MonoBehaviour
{
    #region Variables
    ...
    [Range(0f, 20f)]
    public float blueColorLevel = 13.7f;
    [Range(0f, 3f)]
    public float level = 0.95f;
    #endregion
    ...
    void Start()
    {
        ...
        SCTexture = Resources.Load("images/filter_crisp_0922", typeof(Texture))as Texture;
		blueColorLevel = 13.7f;
		level = 0.95f;
